 ...
 * ```
 *
 * @see https://bible.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bible';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BibleClient] {$message}\n";
        }
    }
}
