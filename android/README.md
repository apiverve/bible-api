...
```gradle
dependencies {
    implementation 'com.github.apiverve:bible-api:1.1.14'
}
```
...
```java
import com.apiverve.bible.BibleAPIClient;
import com.apiverve.bible.APIResponse;
import com.apiverve.bible.APIException;

// Initialize the client
BibleAPIClient client = new BibleAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("book", "Genesis");
    parameters.put("chapter", 5);
    parameters.put("verse", 17);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bible](https://docs.apiverve.com/ref/bible)
...
- **Documentation:** [https://docs.apiverve.com/ref/bible](https://docs.apiverve.com/ref/bible)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bible-api/issues)
