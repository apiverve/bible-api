...
namespace APIVerve.Examples
{
    class BibleExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/bible";

        /// <summary>
        /// Make a GET request to the Bible API
        /// </summary>
        static async Task<JsonDocument> CallBibleAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;book&quot;] &#x3D; &quot;Genesis&quot;, [&quot;version&quot;] &#x3D; &quot;KJV&quot;, [&quot;chapter&quot;] &#x3D; 5, [&quot;verse&quot;] &#x3D; 17 };
        ...
        {
            Console.WriteLine("📤 Calling Bible API...\n");

            var result = await CallBibleAPI();
