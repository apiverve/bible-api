// Package bible provides a Go client for the Bible API.
//
// For more information, visit: https://apiverve.com/marketplace/bible?utm_source=go&utm_medium=readme
package bible
...
// Request contains the parameters for the Bible API.
//
// Parameters:
//   - book (required): string - The name of the book in the bible (e.g., Genesis)
//   - chapter (required): integer - The chapter number in the book [min: 1]
//   - verse: integer - The verse number in the chapter [min: 1]
type Request struct {
	Book string `json:"book"` // Required
	Chapter int `json:"chapter"` // Required
	Verse int `json:"verse,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"chapter": {Type: "integer", Required: true, Min: float64Ptr(1)},
		"verse": {Type: "integer", Required: false, Min: float64Ptr(1)},
	}
...
// ResponseData contains the data returned by the Bible API.
